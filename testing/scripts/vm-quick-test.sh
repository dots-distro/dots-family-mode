...
echo "   sudo -E ./testing/scripts/vm-quick-test.sh"
echo ""
echo "2. For container testing, install NixOS container:"
echo "   cp testing/configs/nixos-container.nix /etc/nixos/containers/dots-testing.nix"
echo "   sudo nixos-rebuild switch"
echo "   sudo nixos-container start dots-testing"
echo ""
echo "3. Run comprehensive integration tests:"
echo "   ./testing/scripts/run-all-tests.sh --all"
