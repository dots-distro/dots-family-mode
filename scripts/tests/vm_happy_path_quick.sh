...
test_result "Systemd service exists" "test -f deployment/systemd/dots-family-daemon.service"
test_result "Install script exists" "test -f deployment/systemd/install.sh"
test_result "DBus service exists" "test -f deployment/dbus/org.dots.FamilyDaemon.service"
...
test_result "Systemd has User config" "grep -q 'User=' deployment/systemd/dots-family-daemon.service"
test_result "Systemd has Restart config" "grep -q 'Restart=' deployment/systemd/dots-family-daemon.service"
test_result "Systemd has CAP_SYS_ADMIN" "grep -q 'CAP_SYS_ADMIN' deployment/systemd/dots-family-daemon.service"
test_result "Systemd has ProtectSystem" "grep -q 'ProtectSystem' deployment/systemd/dots-family-daemon.service"
